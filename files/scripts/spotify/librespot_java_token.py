...
def get_token():
    with open('/opt/librespot-java/credentials.json') as f:
        c = json.load(f)

    output = check_output(["/home/pi/get_token_args", c['username'], c['credentials'], "c1a475bba9294ee7bc4618cc8f711f6b"],
                          encoding='UTF-8')
